...
class MusicianApi_Test(TestCase):
    ...
    def test_create_musician(self):
        ...
        musician_dict = factory.build(dict, FACTORY_CLASS=MusicianFactory,
                                      influencer=self.influencer.id, preferred_song=self.preferred_song.id)
    ...
    def test_create_musician_with_m2m_relations(self):
        ...
        musician_dict = factory.build(dict, FACTORY_CLASS=MusicianFactory, influencer=self.influencer.pk,
                                      preferred_song=self.preferred_song.pk, albums=albums_pks, collab_albums=collab_albums_pks)
