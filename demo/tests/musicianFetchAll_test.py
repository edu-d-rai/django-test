...
class MusicianFetchAll_Test(TestCase):
    def setUp(self):
    ...
    def test_get_one(self):
        ...
        musician_detail_url = reverse('musician-fetch-all-detail', kwargs={'pk': musician_pk})
    ...
    def test_fetch_all(self):
        ...
        """
        client = self.api_client
        response = client.get(reverse('musician-fetch-all-list'))
        assert response.status_code == status.HTTP_200_OK
