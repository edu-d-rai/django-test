...
from .factories import SongFactory, AlbumFactory, MusicianFactory
...
class SongApi_Test(TestCase):
    ...
    def test_create_song(self):
        ...
        song_dict = factory.build(dict, FACTORY_CLASS=SongFactory, album=self.album.name, composer=self.composer.id)
