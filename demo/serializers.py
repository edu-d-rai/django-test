...
class MusicianSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Musician
        fields = ['id', 'first_name', 'last_name', 'instrument', 'age', 'fans', 'inspired_at', 'prod_records', 'main_concerts',
                  'secondary_concerts', 'influenced_musicians', 'composed_songs', 'influencer', 'preferred_song', 'albums', 'collab_albums']
...
class AlbumSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Album
        fields = ['id', 'name', 'genre', 'release_date', 'num_stars', 'ranking',
                  'upc', 'songs', 'producer', 'interpreters', 'collaborators']
